         ...
         <div class="header_section">
            <div class="container">
               <div class="containt_main">
                  ...
                  <span class="toggle_icon" onclick="openNav()"><img src="<?php echo get_template_directory_uri();?>/images/toggle-icon.png"></span>
                  <div class="dropdown">
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <img src="<?php echo get_template_directory_uri();?>/images/flag-uk.png" alt="flag" class="mr-2 " title="United Kingdom"> English <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-menu ">
                           <a href="#" class="dropdown-item">
                           <img src="<?php echo get_template_directory_uri();?>/images/flag-france.png" class="mr-2" alt="flag">
                           French
                           </a>
                        </div>
                     </div>
