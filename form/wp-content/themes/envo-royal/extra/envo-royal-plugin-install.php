<?php
/**
 * Envo Royal Plugin Install Class
 * 
 */
...
if ( ! class_exists( 'Envo_Royal_Plugin_Install' ) ) :
	/**
	 * The Envo Royal plugin install class
	 */
	class Envo_Royal_Plugin_Install {
		...
		public static function install_plugin_button( $plugin_slug, $plugin_file, $plugin_name, $classes = array(), $activated = '', $activate = '', $install = '' ) {
			if ( current_user_can( 'install_plugins' ) && current_user_can( 'activate_plugins' ) ) {
				if ( is_plugin_active( $plugin_slug . '/' . $plugin_file ) ) {
					...
					$button = array(
						'message' => esc_attr__( 'Activated', 'envo-royal' ),
						'url'     => '#',
						'classes' => array( 'envo-royal-button', 'disabled' ),
					);
					...
					$button = array(
						'message' => esc_attr__( 'Activate', 'envo-royal' ),
						'url'     => $url,
						'classes' => array( 'envo-royal-button', 'activate-now' ),
					);
					...
					$button = array(
						'message' => esc_attr__( 'Install now', 'envo-royal' ),
						'url'     => $url,
						'classes' => array( 'envo-royal-button', 'sf-install-now', 'install-now', 'install-' . $plugin_slug ),
					);
				...
				<a href="https://wordpress.org/plugins/<?php echo esc_attr( $plugin_slug ); ?>" target="_blank"><?php esc_html_e( 'Learn more', 'envo-royal' ); ?></a>
				<?php
			}
		}
...
return new Envo_Royal_Plugin_Install();
