<div class="wrap gs-form" id="opener">
  ...
  <div class="gs-card opacity-down">
     ...
     <h2 class="inner-title"><span>CF7 Google Sheet Roles Settings</span> <span class="pro-ver">PRO</span></h2>
     
  	
  
    <div>
      <label>Roles that can access Google Sheet Page</label>
    </div>
    ...
    <div class="select-info">
      <input type="submit" class="button button-primary button-large" name="gs_settings" value="Save">
    </div>
  </div>
</div>
