...
= 1.5.2 =
* Minor function updated.

= 1.5.1 =
* Post style css updated.
...
= 1.4.5 =
* Demo import issues fix for Advanced Import plugin.

= 1.4.4 =
* WooCommerce product rating option added.
* Style issue fixed.
...
= 1.4.1 =
* WooCommerce icon group color option added.
* Style issue fixed.
...
= 1.3.9 =
* Bosa Elementor for WooCommerce plugin installation added to getting started action.
* WooCommerce style updated.

= 1.3.8 =
* Style updated.

= 1.3.7 =
* Sina Extension for Elementor and Contact Form 7 plugins installation added to getting started action.

= 1.3.6 =
* Image size customizer option added.

= 1.3.5 =
* Header image slider issue fix.
* Style updated.

= 1.3.4 =
* Woocommerce customizer options added.
* Style updated.
