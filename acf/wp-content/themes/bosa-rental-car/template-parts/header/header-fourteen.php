<header id="masthead" class="site-header header-fourteen">
	<div class="top-header">
					...
					<div class="container">
						<div class="row align-items-center">
							...
							<div class="col-lg-6 d-none d-lg-flex justify-content-end align-items-center">
								...
								<?php if( !get_theme_mod( 'disable_header_button', false ) && bosa_rental_car_has_header_buttons() ){
									echo '<div class="header-btn">';
										bosa_rental_car_header_buttons();
									echo '</div>';
								} ?>
							</div>
						</div>
		...
		<?php if( !get_theme_mod( 'disable_mobile_top_header', false ) ){ ?>
			<?php if( ( !get_theme_mod( 'disable_header_social_links', false ) && bosa_has_social() ) || ( !get_theme_mod( 'disable_contact_detail', false ) && ( get_theme_mod( 'contact_phone', '' )  || get_theme_mod( 'contact_email', '' )  || get_theme_mod( 'contact_address', '' ) ) ) || !get_theme_mod( 'disable_search_icon', false ) || ( !get_theme_mod( 'disable_header_button', false ) && bosa_rental_car_has_header_buttons() ) || is_active_sidebar( 'menu-sidebar' ) ){ ?>
				...
				<div class="col-lg-9 d-none d-lg-block">
					<div class="main-navigation-wrap">
						<nav id="site-navigation" class="main-navigation">
							<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'bosa-rental-car' ); ?></button>
