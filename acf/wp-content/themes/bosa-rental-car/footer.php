...
?>
	<?php
		$footer_layout = '';
		if( get_theme_mod( 'footer_layout', 'footer_eight' ) == 'footer_one'){
			$footer_layout = 'site-footer-primary';
		}elseif( get_theme_mod( 'footer_layout', 'footer_eight' ) == 'footer_two'){
			$footer_layout = 'site-footer-two';
		}elseif( get_theme_mod( 'footer_layout', 'footer_eight' ) == 'footer_three'){
			$footer_layout = 'site-footer-three';
		}elseif( get_theme_mod( 'footer_layout', 'footer_eight' ) == 'footer_eight'){
			$footer_layout = 'site-footer-eight';
		}
	...
	<footer id="colophon" class="site-footer <?php echo esc_attr( $footer_layout . ' ' . $has_footer_bg ) ?>">
		<div class="site-footer-inner" style="background-image: url(<?php echo esc_url( $footer_image ) ?>">
			...
			<?php if( !get_theme_mod( 'disable_bottom_footer', false ) ) { ?>
				<?php if( get_theme_mod( 'footer_layout', 'footer_eight' ) == '' || get_theme_mod( 'footer_layout', 'footer_eight' ) == 'footer_one' ){
					...
					get_template_part( 'template-parts/footer/footer', 'eight' );
				}
			} ?>
		</div>
	</footer><!-- #colophon -->
