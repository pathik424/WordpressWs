...
function bosa_rental_car_default_styles(){
...
# Header Button
	...
	# Responsive Card Categories
	if( get_theme_mod( 'disable_mobile_category_cards', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
...
add_action( 'wp_head', 'bosa_rental_car_default_styles', 99 );