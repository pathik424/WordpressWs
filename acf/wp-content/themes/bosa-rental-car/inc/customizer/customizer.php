 ...
 */
add_action( 'customize_preview_init', 'bosa_rental_car_customize_preview_js', 999, 1 );

function bosa_rental_car_customize_preview_js() {
	wp_enqueue_script( 'bosa-rental-car-customizer', get_stylesheet_directory_uri() . '/inc/customizer/customizer.js', array( 'customize-preview' ) );
}

function bosa_rental_car_customize_getting_js() {
	wp_dequeue_script( 'bosa-customizer-getting-started' );
	wp_enqueue_script( 'bosa-rental-car-customizer-getting-started', get_stylesheet_directory_uri() . '/inc/getting-started/getting-started.js', array( 'customize-controls', 'jquery' ), true );

	wp_enqueue_style( 'bosa-rental-car-customize-controls', get_stylesheet_directory_uri() . '/inc/customizer/customizer.css' );
}
add_action( 'customize_controls_enqueue_scripts', 'bosa_rental_car_customize_getting_js', 99 );
 ...
 * @return void
 */
add_action( 'init' , 'bosa_rental_car_kirki_fields', 999, 1 );

function bosa_rental_car_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Title', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Description', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu Description', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Body', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'General Title (H1 - H6)', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page & Single Post Title', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Title Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Meta Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Excerpt Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Slider Button Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content Alignment', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'main_slider_content_alignment',
		'section'     => 'main_slider_options',
		'default'     => 'left',
		'choices'  => array(
			'center' => esc_html__( 'Center', 'bosa-rental-car' ),
			'left'   => esc_html__( 'Left', 'bosa-rental-car' ),
			'right'  => esc_html__( 'Right', 'bosa-rental-car' ),
		),
		'priority'	  =>  180,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Title Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Description Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Excerpt Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Widget Title Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Layouts', 'bosa-rental-car' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-rental-car' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Top Header Section', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Height (in px)', 'bosa-rental-car' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Contact Details', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Phone Number', 'bosa-rental-car' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Email', 'bosa-rental-car' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Address', 'bosa-rental-car' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'header_style_options',
	    'default'     => esc_html__( 'Header Button Options', 'bosa-rental-car' ),
	    'priority'	  => 550,
	    'active_callback' => array(
			array(
				'setting'  => 'header_layout',
	...
	// Header button
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Header Buttons', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Buttons', 'bosa-rental-car' ),
		'type'         => 'repeater',
		'settings'     => 'header_button_repeater',
		'section'      => 'header_style_options',
		'row_label' => array(
			'type'  => 'text',
			'value' => esc_html__( 'Button', 'bosa-rental-car' ),
		),
		'default' => array(
			array(
		...
		'fields' => array(
			'header_btn_type' => array(
				'label'       => esc_html__( 'Button Type', 'bosa-rental-car' ),
				'type'        => 'select',
				'default'     => 'button-outline',
				'choices'  	  => array(
					'button-primary' => esc_html__( 'Background Button', 'bosa-rental-car' ),
					'button-outline' => esc_html__( 'Border Button', 'bosa-rental-car' ),
					'button-text'    => esc_html__( 'Text Only Button', 'bosa-rental-car' ),
				),
			),
			'header_btn_bg_color' 	=> array(
				'label'       		=> esc_html__( 'Non Transparent Header Button Background Color', 'bosa-rental-car' ),
				'description' 		=> esc_html__( 'For background button type only.', 'bosa-rental-car' ),
				'type'        		=> 'color',
				'default'     		=> '#EB5A3E',
			),
			'header_btn_border_color' 	=> array(
				'label'      	 		=> esc_html__( 'Non Transparent Header Button Border Color', 'bosa-rental-car' ),
				'description' 			=> esc_html__( 'For border button type only.', 'bosa-rental-car' ),
				'type'       		 	=> 'color',
				'default'     			=> '#1a1a1a',
			),
			'header_btn_text_color' => array(
				'label'       		=> esc_html__( 'Non Transparent Header Button Text Color', 'bosa-rental-car' ),
				'type'        		=> 'color',
				'default'     		=> '#1a1a1a',
			),
			'header_btn_hover_color' => array(
				'label'       		=> esc_html__( 'Non Transparent Header Button Hover Color', 'bosa-rental-car' ),
				'type'        		=> 'color',
				'default'     		=> '#086abd',
			),
			'header_btn_text' => array(
				'label'       => esc_html__( 'Button Text', 'bosa-rental-car' ),
				'type'        => 'text',
				'default' 	  => '',
			),
			'header_btn_link' => array(
				'label'       => esc_html__( 'Button Link', 'bosa-rental-car' ),
				'type'        => 'text',
				'default' 	  => '#',
			),
			'header_btn_target' => array(
				'label'       	=> esc_html__( 'Open Link in New Window', 'bosa-rental-car' ),	
				'type'        	=> 'checkbox',
				'default'	  	=> true,
			),
			'header_btn_radius' => array(
				'label'       	=> esc_html__( 'Button Radius (px)', 'bosa-rental-car' ),
				'type'        	=> 'number',
				'default'	  	=> 0,
				'choices'     	=> array(
					'min'  => 0,
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Buttons Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'header_style_options',
	    'default'     => esc_html__( 'Contact Details Options', 'bosa-rental-car' ),
	    'priority'	   => 440,
	    'active_callback' => array(
			array(
				'setting'  => 'header_layout',
				'operator' => 'contains',
				'value'    => array( 'header_one', 'header_two', 'header_four', 'header_fourteen' ),
			),
		),
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Contact Detail Icon color', 'bosa-rental-car' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Phone Label', 'bosa-rental-car' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Contact Label Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Contact Content Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Mid Header Section Border', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Header Contact Details', 'bosa-rental-car' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa',  array(
		'label'       => esc_html__( 'Post Title Position', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'post_title_position',
		'section'     => 'single_post_options',
		'default'     => 'above_feature_image',
		'choices'     => array(
			'below_feature_image' => esc_html__( 'Below Feature Image', 'bosa-rental-car' ),
			'above_feature_image' => esc_html__( 'Top of the Page', 'bosa-rental-car' ),
		),
		'priority'	   => 20,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Feature Image', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'single_feature_image',
		'section'     => 'single_post_options',
		'default'     => 'show_in_all_pages',
		'choices' => array(
			'show_in_all_pages'    => esc_html__( 'Show in all Pages', 'bosa-rental-car' ),
			'disable_in_all_pages' => esc_html__( 'Disable in all Pages', 'bosa-rental-car' ),
		),
		'priority'	   => 30,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa',  array(
		'label'       => esc_html__( 'Page Title Position', 'bosa-rental-car' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		...
		'choices' => array(
			'show_in_all_pages'    => esc_html__( 'Show in all Pages', 'bosa-rental-car' ),
			'disable_in_all_pages' => esc_html__( 'Disable in all Pages', 'bosa-rental-car' ),
			'disable_in_frontpage' => esc_html__( 'Disable in Frontpage only', 'bosa-rental-car' ),
			'show_in_frontpage'    => esc_html__( 'Show in Frontpage only', 'bosa-rental-car' ),
		),
		'priority'	   => 30,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Footer Layouts', 'bosa-rental-car' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Bottom Footer Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Select Image', 'bosa-rental-car' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Link', 'bosa-rental-car' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Target', 'bosa-rental-car' ),
		'description' => esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-rental-car' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Width', 'bosa-rental-car' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Border', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_options', array(
	    'title'          => esc_html__( 'Featured Posts / Pages', 'bosa-rental-car' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts / Pages', 'bosa-rental-car' ),
		...
		'priority'    => '9',
		'choices'  => array(
			'featured_posts' => esc_html__( 'Featured Posts', 'bosa-rental-car' ),
			'featured_pages' => esc_html__( 'Featured Pages', 'bosa-rental-car' ),
		)
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Section', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Title', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Description', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Description', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title and Description Alignment', 'bosa-rental-car' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Layout', 'bosa-rental-car' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-rental-car' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Color', 'bosa-rental-car' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Background Color', 'bosa-rental-car' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Color', 'bosa-rental-car' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Text Color', 'bosa-rental-car' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Icon Color', 'bosa-rental-car' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Hover Color', 'bosa-rental-car' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Columns', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_columns',
		'section'     => 'feature_posts_options',
		'default'     => 'three_columns',
		'placeholder' => esc_attr__( 'Select category', 'bosa-rental-car' ),
		'choices'  => array(
			'one_column'    => esc_html__( '1 Column', 'bosa-rental-car' ),
			'two_columns'   => esc_html__( '2 Columns', 'bosa-rental-car' ),
			'three_columns' => esc_html__( '3 Columns', 'bosa-rental-car' ),
			'four_columns'  => esc_html__( '4 Columns', 'bosa-rental-car' ),
		),
		'priority'	  =>  160,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Category', 'bosa-rental-car' ),
		'description' => esc_html__( 'Recent posts will show if any category is not chosen.', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_category',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select category', 'bosa-rental-car' ), 
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts Overlay Opacity', 'bosa-rental-car' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post View Number', 'bosa-rental-car' ),
		'description'  => esc_html__( 'Number of posts to show.', 'bosa-rental-car' ),
		'type'         => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Height (in px)', 'bosa-rental-car' ),
		'description'  => esc_html__( 'This option will only apply to Desktop. Please click on below Desktop Icon to see changes. Automatically adjust by theme default in the responsive devices.
		', 'bosa-rental-car' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'render_feature_post_image_size',
		'section'     => 'feature_posts_options',
		'default'     => 'bosa-420-300',
		'placeholder' => esc_html__( 'Select Image Size', 'bosa-rental-car' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Background Image Size', 'bosa-rental-car' ),
		'type'         => 'radio',
		'settings'     => 'feature_posts_image_size',
		'section'      => 'feature_posts_options',
		'default'      => 'cover',
		'choices'      => array(
			'cover'    => esc_html__( 'Cover', 'bosa-rental-car' ),
			'pattern'  => esc_html__( 'Pattern / Repeat', 'bosa-rental-car' ),
			'norepeat' => esc_html__( 'No Repeat', 'bosa-rental-car' ),
		),
		'priority'	   =>  220,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Border Radius (px)', 'bosa-rental-car' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Text Alignment', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_text_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'text-left',
		'choices'     => array(
			'text-left'	 	=> esc_html__( 'Left', 'bosa-rental-car' ),
			'text-center'  	=> esc_html__( 'Center', 'bosa-rental-car' ),   
			'text-right'	=> esc_html__( 'Right', 'bosa-rental-car' ),
		),
		'priority'	  =>  240,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Alignment', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_title_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'align-bottom',
		'choices'     => array(
			'align-top'	 	=> esc_html__( 'Top', 'bosa-rental-car' ),
			'align-center'  => esc_html__( 'Center', 'bosa-rental-car' ),   
			'align-bottom'  => esc_html__( 'Bottom', 'bosa-rental-car' ),
		),
		'priority'	  =>  250,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title', 'bosa-rental-car' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title Divider', 'bosa-rental-car' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Posts category', 'bosa-rental-car' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Date', 'bosa-rental-car' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Author', 'bosa-rental-car' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Comment', 'bosa-rental-car' ),
		'type'        => 'checkbox',
	...
	// featured pages
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Pages Section', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 1', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_one',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 1', 'bosa-rental-car' ),
		'choices'     => bosa_rental_car_get_pages(),
		'priority'	  => 450,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 2', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_two',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 2', 'bosa-rental-car' ),
		'choices'     => bosa_rental_car_get_pages(),
		'priority'	  => 460,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 3', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_three',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_rental_car_get_pages(),
		'placeholder' => esc_html__( 'Select Page 3', 'bosa-rental-car' ),
		'priority'	  => 470,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 4', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_four',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_rental_car_get_pages(),
		'placeholder' => esc_html__( 'Select Page 4', 'bosa-rental-car' ),
		'priority'	  => 480,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Page Overlay Opacity', 'bosa-rental-car' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Border Radius (px)', 'bosa-rental-car' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Page Title', 'bosa-rental-car' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Color', 'bosa-rental-car' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Hover Color', 'bosa-rental-car' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Horizontal Alignment', 'bosa-rental-car' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Vertical Alignment', 'bosa-rental-car' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts / Pages', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_advert_banner_options', array(
	    'title'          => esc_html__( 'Blog Advertisement Banner', 'bosa-rental-car' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => '24',
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Banner', 'bosa-rental-car' ),
		'description'  => esc_html__( 'Image dimensions 1230 by 100 pixels is recommended.', 'bosa-rental-car' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Advertisement Banner Link', 'bosa-rental-car' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    		=> esc_html__( 'Advertisement Banner Target', 'bosa-rental-car' ),
		'description' 	=> esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-rental-car' ),
		'type'     		=> 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement Banner', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_two_options', array(
	    'title'          => esc_html__( 'Featured Posts Two', 'bosa-rental-car' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 25,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two Section', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Overlay Opacity', 'bosa-rental-car' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Horizontal Alignment', 'bosa-rental-car' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Vertical Alignment', 'bosa-rental-car' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Layouts', 'bosa-rental-car' ),
		'description' => esc_html__( 'Grid / List / Single/ Grid Thumbnail', 'bosa-rental-car' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'blog_page_style_options',
	    'default'     => esc_html__( 'Thumbnail Post Options', 'bosa-rental-car' ),
	    'priority'	  => 300,
	    'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-rental-car' ),
		'description' => esc_html__( 'Image Size for thumbnail post only.', 'bosa-rental-car' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Border Radius (px)', 'bosa-rental-car' ),
		'description' => esc_html__( 'Post Border Radius for thumbnail post only.', 'bosa-rental-car' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Date', 'bosa-rental-car' ),
		'description'  => esc_html__( 'Disables date for thumbnail post only.', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Author', 'bosa-rental-car' ),
		'description'  => esc_html__( 'Disables author for thumbnail post only.', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Comment Link', 'bosa-rental-car' ),
		'description'  => esc_html__( 'Disables comment link for thumbnail post only.', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Excerpt', 'bosa-rental-car' ),
		'description'  => esc_html__( 'Disables excerpt for thumbnail post only.', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Post Button', 'bosa-rental-car' ),
		'description'  => esc_html__( 'Disables button for thumbnail post only.', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_services', array(
	    'title'          => esc_html__( 'Services', 'bosa-rental-car' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 26,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services Section', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_category_cards', array(
	    'title'          => esc_html__( 'Category Cards', 'bosa-rental-car' ),
	    'description'  	 => esc_html__( 'WooCommerce plugin is required for this section.', 'bosa-rental-car' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 27,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Category Card Section', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'blog_category_cards',
	    'default'     => esc_html__( 'Card One', 'bosa-rental-car' ),
	    'priority'	  => 30,
	) );

	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Title One', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image One', 'bosa-rental-car' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image One Category', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'card_category_one',
		'section'     => 'blog_category_cards',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category One', 'bosa-rental-car' ),
		'choices'     => bosa_rental_car_get_product_categories(),
		'priority'	  => 60,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Two', 'bosa-rental-car' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Two Category', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'card_category_two',
		'section'     => 'blog_category_cards',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Two', 'bosa-rental-car' ),
		'choices'     => bosa_rental_car_get_product_categories(),
		'priority'	  => 80,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Three', 'bosa-rental-car' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Three Category', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'card_category_three',
		'section'     => 'blog_category_cards',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Three', 'bosa-rental-car' ),
		'choices'     => bosa_rental_car_get_product_categories(),
		'priority'	  => 100,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Four', 'bosa-rental-car' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Four Category', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'card_category_four',
		'section'     => 'blog_category_cards',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Four', 'bosa-rental-car' ),
		'choices'     => bosa_rental_car_get_product_categories(),
		'priority'	  => 120,
	) );
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'blog_category_cards',
	    'default'     => esc_html__( 'Card Two', 'bosa-rental-car' ),
	    'priority'	  => 130,
	) );

	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Title Two', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Five', 'bosa-rental-car' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Five Category', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'card_category_five',
		'section'     => 'blog_category_cards',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Five', 'bosa-rental-car' ),
		'choices'     => bosa_rental_car_get_product_categories(),
		'priority'	  => 160,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Six', 'bosa-rental-car' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Six Category', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'card_category_six',
		'section'     => 'blog_category_cards',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Six', 'bosa-rental-car' ),
		'choices'     => bosa_rental_car_get_product_categories(),
		'priority'	  => 180,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Seven', 'bosa-rental-car' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Seven Category', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'card_category_seven',
		'section'     => 'blog_category_cards',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Seven ', 'bosa-rental-car' ),
		'choices'     => bosa_rental_car_get_product_categories(),
		'priority'	  => 200,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Eight', 'bosa-rental-car' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Eight Category', 'bosa-rental-car' ),
		'type'        => 'select',
		'settings'    => 'card_category_eight',
		'section'     => 'blog_category_cards',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Eight ', 'bosa-rental-car' ),
		'choices'     => bosa_rental_car_get_product_categories(),
		'priority'	  => 220,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Category Cards', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_testimonials', array(
	    'title'          => esc_html__( 'Testimonials', 'bosa-rental-car' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 28,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Testimonials Section', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Testimonials', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_fun_facts', array(
	    'title'          => esc_html__( 'Fun Facts', 'bosa-rental-car' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 29,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Fun Facts Section', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact one', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact One Content', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Two', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Two Content', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Three', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Three Content', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Four', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Four Content', 'bosa-rental-car' ),
		'type'        => 'text',
	...
	kirki::add_field('bosa',array(
		'label'        => esc_html__( 'Disable Fun Facts', 'bosa-rental-car' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Title Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Price Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Add to Cart Button Typography', 'bosa-rental-car' ),
		'type'         => 'typography',
