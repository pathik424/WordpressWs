...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			<?php
			//Feature Posts / Pages Section
			if( get_theme_mod( 'feature_posts_pages_tab', 'featured_posts' ) == 'featured_posts' ){
			...
			}elseif( get_theme_mod( 'feature_posts_pages_tab', 'featured_posts' ) == 'featured_pages' ){
			...
			<?php bosa_rental_car_blog_advertisement_banner(); ?>
			...
			<?php if (class_exists ('woocommerce') ) { ?>
			 	<?php get_template_part( 'template-parts/card-categories/card-categories' ); ?>
			<?php } ?>
			...
			<!--Fun-Facts-->
			<?php get_template_part( 'template-parts/fun-facts/fun-facts' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-rental-car' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-rental-car' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-rental-car' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-rental-car' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-rental-car' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
