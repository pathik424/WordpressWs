...
if (!function_exists('wcps_metabox_content_style')) {
    function wcps_metabox_content_style($post_id)
    {
        ...
        $item_padding = isset($item_style['padding']) ? $item_style['padding'] : '15px';
...
if (!function_exists('wcps_metabox_content_query_product')) {
    ...
    ?>
        <div class="section">
            ...
            $wcps_query_orderby_args = apply_filters(
...
if (!function_exists('wcps_metabox_content_slider_options')) {
    function wcps_metabox_content_slider_options($post_id)
    {
        ...
        $navigation_background_color = isset($slider_option['navigation_background_color']) ? $slider_option['navigation_background_color'] : '#1e6fcc';
        $navigation_color = isset($slider_option['navigation_color']) ? $slider_option['navigation_color'] : '#ffffff';
